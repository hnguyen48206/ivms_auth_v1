    ...
    actions: {
        assignCamToOrg: {
            ...
            async handler(ctx) {
                    ...
                    return this.adapter.db.query(`CALL org_serv_insert_delete_select('${ctx.params.serverID}','${ctx.params.orgID}','Insert')`)
                    .then((res) => {
                        ...
                        return resultHandler(1, "Gán server vào org thành công", {});
                    } 
                    )
                    .catch(err => { 
                        let error = () => {
        ...
        removeCamFromOrg: {
            ...
            async handler(ctx) {
                    ...
                    return this.adapter.db.query(`CALL org_serv_insert_delete_select('${ctx.params.serverID}','${ctx.params.orgID}','Delete')`)
                    .then((res) => {
                        this.broker.call("logging.logUserAction", {
                            userID: tokenManager.decodeToken(ctx.meta.reqHeaders.token).userID,
                            action: ctx.meta.endpoint,
                        ...
                        return resultHandler(1, "Remove server khỏi org thành công", {});
                    } 
                    )
                    .catch(err => { 
                        let error = () => {
