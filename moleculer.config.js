...
module.exports = {
	...
	transporter: "TCP", //"AMQP"
	// transporter: {
    //     type: "AMQP",
    //     options: {
    //         url: "amqp://guest:guest@10.70.123.5:8180",
	...
	cacher: (process.env.USE_DB_CACHE.toString() == '1') ? "Memory" : {
		type: "Redis",
		options: {
			redis: {
	...
	errorHandler: null,//parse error
	// errorHandler: function(err, info) {
	// 	console.log(`Error occurs from service ${info}`);
	// },
